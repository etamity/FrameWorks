package com.smart.engine.starling.textureAlas
{

	import com.smart.engine.starling.textureAlas.TextureItem;
	...
	public class DynamicAtlas
	{
		...
		*/
		...
		static public function formDisplayObject(clip:DisplayObject):Texture {
			...
			return Texture.fromBitmapData(bData);
